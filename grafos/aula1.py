...
class Grafo:
    ...
    lugoj.adiciona_adjacente(Adjacente(timisoara, 75))
    lugoj.adiciona_adjacente(Adjacente(mehadia, 75))
    
    mehadia.adiciona_adjacente(Adjacente(lugoj, 75))
    mehadia.adiciona_adjacente(Adjacente(dobreta, 75))
    
    rimnicu.adiciona_adjacente(Adjacente(craiova, 75))
    rimnicu.adiciona_adjacente(Adjacente(sibiu, 75))
    rimnicu.adiciona_adjacente(Adjacente(pitesti, 75))
    
    fagaras.adiciona_adjacente(Adjacente(sibiu, 75))
    fagaras.adiciona_adjacente(Adjacente(bucharest, 75))
    
    pitesti.adiciona_adjacente(Adjacente(rimnicu, 75))
    pitesti.adiciona_adjacente(Adjacente(craiova, 75))
    pitesti.adiciona_adjacente(Adjacente(bucharest, 75))
    
    bucharest.adiciona_adjacente(Adjacente(fagaras, 75))
    bucharest.adiciona_adjacente(Adjacente(pitesti, 75))
    bucharest.adiciona_adjacente(Adjacente(giurgiu, 75))
...
print(busca_profundidade.pilha.ver_topo())
